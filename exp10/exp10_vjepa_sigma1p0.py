...
===========================================================
Condition : MODEL=VJEPA     SIGMA=1.0  SEED=0
...
Instructions
  ...
  5. After completion share the checkpoint file:
         ckpt_cheetah_vjepa_s1.0_seed0.json
...
MODEL_TYPE = 'vjepa'   # 'vjepa', 'jepa', or 'dreamer'
SIGMA      = 1.0       # background Gaussian noise σ  (0.0 / 0.5 / 1.0)
